...
export default function Home() {
  return (
    <>
      ...
      <main>
        {/* <Image src="/tejj-o8iXJVAahUc-unsplash.jpg" style={{height:"100vh",width:"100vw"}} fluid /> */}
        <div style={{ display: 'block', width: "100vw",height:'100vh', padding: 30 }}>
      
      <Carousel>
        <Carousel.Item interval={1500}>
          <img
            className="d-block w-100"
src="/tejj-o8iXJVAahUc-unsplash.jpg"
            alt="Image One" style={{width:'100vw',height:'100vh'}}
          />
          <Carousel.Caption>
...
src="/coffee-brewing.jpeg"
        ...
        <Carousel.Item interval={500}>
          <img
            className="d-block w-100"
src="/cafe-people.jpg"
            alt="Image Two" style={{width:'100vw',height:'100vh'}}
          />
          <Carousel.Caption>
